...
function About() {
  return (
    ...
    >
      ...
      <div>
        <p className="mb-4">
          Em 2016, tive meu primeiro contato com o mundo da tecnologia ao me
          interessar no jogo{" "}
          <a
          ...
          feito pela Mojang, decidi explorar como funcionava a codificação por
          detrás dos panos deste jogo sensacional que naquela época era uma dos
          jogos mais apreciados pelos meus colegas de classe.
        </p>
        <p className="mb-4">
          Nessa "aventura" que surgiu como um hobby, construí os meus primeiros
          algoritmos de comunicação entre o servidor e o cliente, e foi ali que
          descobri que a minha curiosidade era uma paixão genuína pela
          programação. Avançando até hoje, tive o privilégio de trabalhar com
          mentes brilhantes no mundo corporativo da esfera pública, além de
          participar de eventos e palestras ao longo da minha carreira
          acadêmica.
        </p>
        <p>
          Meu foco principal atualmente é construir aplicações robustas e
          escaláveis como desenvolvedor Backend, seja nos meus projetos pessoais
          ou para algum cliente como trabalhador autônomo. Eu gosto de criar
          softwares no ponto ideal onde os padrões de arquitetura e a engenharia
          se comunicam para a resolução de eventuais problemas — isto é,
          softwares que ao mesmo tempo sejam úteis para a sociedade por natureza
          mas também bem-estruturados em nível de código.
        </p>
      </div>
    </section>
  );
            ...
            <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
              ...
              <div className="z-10 sm:col-span-6">
                ...
                <a
                  ...
                  href="/tcc/TCC_MARCOS_B_CAMPOS.pdf"
                  target="_blank"
                  rel="noreferrer noopener"
                ...
                >
                  ...
                  />
                  <span>
                    <span className="font-bold ml-2">TCC:</span> Extração de
                    características em snoRNAs usando modelos matemáticos.
                  </span>
                </a>

                <p className="mt-2 text-sm leading-normal">
                  Os algoritmos de extração de características que empregam
                  abordagens matemáticas, em contraposição aos tradicionais
                  algoritmos genéticos de extração, têm provado ser altamente
                  eficazes na classificação dos snoRNAs. Eles alcançaram uma
                  taxa de precisão superior a 90% na avaliação da predição, o
                  que evidencia sua utilidade na identificação desses pequenos
                  RNAs em sequências de vertebrados e invertebrados.
                </p>
                <ul
          ...
          <li className="mb-12">
            <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
              ...
              <div className="z-10 sm:col-span-6">
                ...
                <p className="mt-2 text-sm leading-normal">
                  Contruir e manter componentes em layout responsivo usados para
                  construir o frontend do site Caronas Burguer, em todas as
                  páginas. Trabalhei como desenvolvedor independente de acordo
                  com as sugestões propostas pelo dono da hamburgueria, para
                  implementar e providenciar a melhor experiência ao usuário.
                </p>
                <ul
                  className="mt-2 flex flex-wrap"
          ...
          <li className="mb-12">
            <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
              ...
              <div className="z-10 sm:col-span-6">
                ...
                <p className="mt-2 text-sm leading-normal">
                  Construir, customizar, implementar e corrigir as
                  funcionalidades para os clientes do sistema Radex. Integrar os
                  microsserviços da rede interna do TCU em colaboração com os
                  auditores de controle interno e externo, conforme o Regimento
          ...
          <li className="mb-12">
            <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
              ...
              <div className="z-10 sm:col-span-6">
                <h3 className="font-medium leading-snug text-slate-200">
                  <div>
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer noopener"
                      aria-label="Cientista de Dados na EBSERH (abre em uma nova aba)"
                    >
                      <span className="absolute -inset-x-4 -inset-y-2.5 hidden rounded md:-inset-x-6 md:-inset-y-4 lg:block"></span>
                      <span>
                        Cientista de Dados ·{" "}
                ...
                <p className="mt-2 text-sm leading-normal">
                  Atuava no setor de Análise e Dimensionamento de Pessoal,
                  responsável por administrar a base de dados de todos os
                  hospitais universitários federais regidos pela Empresa
                  Brasileira de Serviços Hospitalares. Desenvolvi um algoritmo
                  de aprendizado de máquina supervisionado capaz de extrair o
                  texto de imagens usando a biblioteca de código aberto chamada
                  Tesseract.
                </p>
                <ul className="mt-2 flex flex-wrap" aria-label="Related links">
                  <li className="mr-4">
                    <a
                      className="relative mt-2 inline-flex items-center text-sm font-medium text-slate-300 hover:text-sky-300 focus-visible:text-sky-300"
                      href="https://www.gov.br/ebserh/pt-br/hospitais-universitarios"
                      target="_blank"
                      rel="noreferrer noopener"
                      aria-label="HUF's regidos pela EBSERH (abre em uma nova aba)"
                    >
                      <Image
                        className="relative dark:drop-shadow-[0_0_0.3rem_#ffffff70] dark:invert"
                        src="/link.svg"
                  ...
                  <li className="mr-4">
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer noopener"
                      aria-label="Ministério da Saúde (abre em uma nova aba)"
                    >
                      <Image
                        className="relative dark:drop-shadow-[0_0_0.3rem_#ffffff70] dark:invert"
                        src="/link.svg"
            ...
            <div className="group relative grid justify-items-center sm:justify-items-start gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
              ...
              <div className="z-10 sm:order-2 sm:col-span-6">
                <h3>
                  <a
                    className="inline-flex items-baseline font-medium leading-tight text-slate-200 hover:text-sky-300 focus-visible:text-sky-300  group/link text-base"
                    href="https://marcos-c1.github.io/covid-app-io/"
                    target="_blank"
                    rel="noreferrer noopener"
                ...
                <p className="mt-2 text-sm leading-normal">
                  Um aplicativo web e mobile informativo sobre a incidência da
                  doença COVID-19 nos estados brasileiros de forma transparência
                  consumindo as APIs públicas do Ministério da Saúde. Os tópicos
                  abordados incluem os sintomas graves e comuns da doença e os
                  cuidados especiais que devem ser tomados caso o paciente
            ...
            <div className="group relative justify-items-center sm:justify-items-start grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
              ...
              <div className="z-10 sm:order-2 sm:col-span-6">
                <h3>
                  <a
                    className="inline-flex items-baseline font-medium leading-tight text-slate-200 hover:text-sky-300 focus-visible:text-sky-300  group/link text-base"
                    href="https://github.com/marcos-c1/crud-rh"
                    target="_blank"
                    rel="noreferrer noopener"
                ...
                <p className="mt-2 text-sm leading-normal">
                  Uma aplicação desktop básica que implementa as quatro funções
                  básicas que os modelos devem ser capazes de realizar, que são{" "}
                  <b>CREATE</b>, <b>READ</b>, <b>UPDATE</b> e <b>DELETE</b>{" "}
                  (CRUD) para o cadastramento de clientes.
                </p>
                <ul
                  className="mt-2 flex flex-wrap"
                  aria-label="Technologies used:"
            ...
            <div className="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
              ...
              <div className="z-10 sm:order-2 sm:col-span-6">
                <h3>
                  <a
                    className="inline-flex items-baseline font-medium leading-tight text-slate-200 hover:text-sky-300 focus-visible:text-sky-300  group/link text-base"
                    href="https://github.com/marcos-c1/hypernova"
                    target="_blank"
                    rel="noreferrer noopener"
                    aria-label="Hypernova Theme (abre em uma nova aba)"
                  >
                    <span className="absolute -inset-x-4 -inset-y-2.5 hidden rounded md:-inset-x-6 md:-inset-y-4 lg:block"></span>
                    <span>
                      Hypernova{" "}
                ...
                <p className="mt-2 text-sm leading-normal">
                  Um tema escuro para VSCode baseado no tema{" "}
                  <a
                    className="font-bold"
              ...
              <Image
                alt="Hypernova Theme with screenshot of VS Code editor"
                src="/hypernova-extension.png"
                loading="lazy"
                width="200"
                height="48"
                decoding="async"
            ...
            <div className="group relative justify-items-center sm:justify-items-start grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
              ...
              <div className="z-10 sm:order-2 sm:col-span-6">
                <h3>
                  <a
                    className="inline-flex items-baseline font-medium leading-tight text-slate-200 hover:text-sky-300 focus-visible:text-sky-300  group/link text-base"
                    href="https://marcosc1.vercel.app/"
                    target="_blank"
                    rel="noreferrer noopener"
                ...
                <p className="mt-2 text-sm leading-normal">
                  Um antigo site de portfólio construído com Vercel para expor
                  meus projetos pessoais e minhas experiências profissionais.
                </p>
                <a
                  className="relative mt-2 inline-flex items-center text-sm font-medium text-slate-300 hover:text-sky-300 focus-visible:text-sky-300"
                  ...
                  target="_blank"
                  rel="noreferrer noopener"
                  aria-label="7317 stars on GitHub (opens in a new tab)"
                ></a>
                <ul
                  className="mt-2 flex flex-wrap"
                  aria-label="Technologies used:"
